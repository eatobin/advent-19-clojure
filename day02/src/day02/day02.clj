...
;;         answer-1             (get (:memory final-state-a) 0)
;;         raw (find-winner the-main-memory)
;;         pair (first raw)
;;         noun (first pair)
;;         verb (last pair)
;;         answer-2 (+ (* 100 noun) verb)
;;         initial-state-b {:pointer 0 :memory (lib/updated-memory noun verb the-main-memory) :actions '()}
...
;; 
;;     ;; part b
;;     (printf "%nPart B answer: %s, correct: 8226%n" answer-2)
