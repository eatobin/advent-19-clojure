...
(defn op-code-2 [[pointer phase input memory]]
      ...
      (case instruction
        ...
        3 (recur
            ...
            (if (= 0 pointer)
              ...
              (assoc memory (memory (+ 1 pointer)) input))
            exit-code)
        4 [(memory (memory (+ 1 pointer))) (+ 2 pointer) phase memory]
        104 [(memory (+ 1 pointer)) (+ 2 pointer) phase memory]
        5 (recur
            (if (= 0 (memory (memory (+ 1 pointer))))
              (+ 3 pointer)
              (memory (memory (+ 2 pointer))))
...
;=> 4
(op-code-2 [0 4 0 b])
;=> [14 4 4 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 4 0]]
(op-code-2 [14 4 4 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 4 0]])
;=> 0
(op-code 3 4 b)
;=> 43
(op-code-2 [0 3 4 b])
;=> [14 3 43 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 43 40]]
(op-code-2 [14 3 43 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 43 40]])
;=> 0
(op-code 2 43 b)
;=> 432
(op-code-2 [0 2 43 b])
;=> [14 2 432 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 432 430]]
(op-code-2 [14 2 432 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 432 430]])
;=> 0
(op-code 1 432 b)
;=> 4321
(op-code-2 [0 1 432 b])
;=> [14 1 4321 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 4321 4320]]
(op-code-2 [14 1 4321 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 4321 4320]])
;=> 0
(op-code 0 4321 b)
;=> 43210
(op-code-2 [0 0 4321 b])
;=> [14 0 43210 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 43210 43210]]
(op-code-2 [14 0 43210 [3 15 3 16 1002 16 10 16 1 16 15 15 4 15 99 43210 43210]])
;=> 0
...
(op-code-2 [0 9 0 bb])
;=> [18 9 5 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 5 5 5]]
(op-code-2 [0 8 5 bb])
;=> [18 8 14 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 4 14 5]]
(op-code-2 [0 7 14 bb])
;=> [18 7 31 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 3 31 5]]
(op-code-2 [0 6 31 bb])
;=> [18 6 64 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 2 64 5]]
(op-code-2 [0 5 64 bb])
;=> [18 5 129 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 1 129 5]]
(op-code-2 [18 9 129 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 5 5 5]])
;=> [18 9 263 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26 27 4 27 1001 28 -1 28 1005 28 6 99 5 263 4]]
