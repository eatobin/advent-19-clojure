...
(defn print-a
  "Invoke me with clojure -X:day01 advent-19-clojure.day01/print-a"
  [_]
  (println)
...
(defn print-b
  "Invoke me with clojure -X:day01 advent-19-clojure.day01/print-b"
  [_]
  (println)
